...
## Cournot Duopoly where investments are not always successful. Specifying state transitions using the helper function `independent_transitions`
...
# Small subset of relevant rows
df = tibble(
  x="0_0",x1=0,x2=0,i1=c(0,1),i2=1
)
df

# Use independent_transitions
independent_transitions(df,
  trans_var("new_x1",default=x1,
    trans_val(val=x1+1,prob=i1*sp)
  ),
  trans_var("new_x2",default=x2,
    trans_val(val=x2+1,prob=i2*sp)
  )
)
```
